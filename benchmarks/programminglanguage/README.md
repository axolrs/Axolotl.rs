# programminglanguage - build-your-own-x port
...
## Why programminglanguage

A tree-walking interpreter for a small Lisp - exercises Axolotl's own surface; if Axolotl can write a language implementation ergonomically, the language works.
